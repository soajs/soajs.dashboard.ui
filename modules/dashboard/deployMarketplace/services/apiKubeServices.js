"use strict";
let apiKubeServicesSrv = soajsApp.components;
apiKubeServicesSrv.service('apiKubeServicesSrv', ['ngDataApi', '$cookies', '$modal', '$timeout', function (ngDataApi, $cookies, $modal, $timeout) {
				...
				$scope.getSecrets(function () {
					$scope.getConfigurationCatalogs(catalog, function () {
						...
						if (catalog.recipe && catalog.recipe.deployOptions) {
							...
							if (!$scope.isDeployed || !$scope.configuration.recipe.livenessProbe) {
