...
var environmentsNav = [
	{
		...
		'scripts': [
			...
			'modules/dashboard/environments2/add/controller.js',
			...
			'modules/dashboard/environments2/add/containerSrv.js',
			'modules/dashboard/environments2/infra/services/container.js',
			
			'modules/dashboard/environments2/add/vmSrv.js',
			...
			'modules/dashboard/environments2/add/dynamic/custom_registrySrv.js',
			'modules/dashboard/environments2/add/dynamic/secretsSrv.js',
			'modules/dashboard/environments2/add/dynamic/repoSrv.js',
			'modules/dashboard/environments2/add/dynamic/resourceSrv.js',
			
			'modules/dashboard/environments2/add/statusSrv.js',
			'modules/dashboard/environments2/add/statusAPISrv.js',
	...
	},
	{
		...
		'tplPath': 'modules/dashboard/environments2/directives/list-cloud-kube.tmpl',
		'icon': 'sphere',
		'pillar': {
			'name': 'deployment',
			'label': translation.deploy[LANG],
		...
		'scripts': [
			'modules/dashboard/environments2/config.js',
			'modules/dashboard/environments2/clouds.js',
			'modules/dashboard/environments2/services/secretsService.js',
