"use strict";
var awsInfraGroupSrv = soajsApp.components;
awsInfraGroupSrv.service('awsInfraGroupSrv', ['ngDataApi', '$timeout', '$modal', '$window', '$cookies', 'Upload', 'infraCommonSrv', function (ngDataApi, $timeout, $modal, $window, $cookies, Upload, infraCommonSrv) {
