"use strict";
let customkubeServicesSrv = soajsApp.components;
customkubeServicesSrv.service('customkubeServicesSrv', ['ngDataApi', '$cookies', '$modal', '$timeout', function (ngDataApi, $cookies, $modal, $timeout) {
