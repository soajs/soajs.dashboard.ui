"use strict";
let statickubeServicesSrv = soajsApp.components;
statickubeServicesSrv.service('statickubeServicesSrv', ['ngDataApi', '$cookies', '$modal', '$timeout', function (ngDataApi, $cookies, $modal, $timeout) {
