		...
		add: {
			deploy: {
				"entries": [
					{
						"name": "deployment",
						"directive": "modules/dashboard/environments2/directives/add/deploy.tmpl"
					}
				]
			},
			registry: {
				"entries": [
					{
						"name": "registry",
						"directive": "modules/dashboard/environments2/directives/add/registry.tmpl"
					}
				]
			},
			nginx: {
				"entries": [
					{
						"name": "nginx",
						"directive": "modules/dashboard/environments2/directives/add/nginx.tmpl"
					}
				]
			}
		},
