"use strict";
let resourcekubeServicesSrv = soajsApp.components;
resourcekubeServicesSrv.service('resourcekubeServicesSrv', ['ngDataApi', '$cookies', '$modal', '$timeout', function (ngDataApi, $cookies, $modal, $timeout) {
