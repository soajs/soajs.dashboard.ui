'use strict';
var gaTranslation = {
	gitAccountManagement :{
		ENG: "Git Account Management",
		FRA: "Git Account Management"
	},
	addAccount :{
		ENG: "Add Account",
		FRA: "Add Account",
	...
	pleaseProvideOn2fa: {
		ENG: "Please provide your Two Factor Authentication Code",
		FRA: "Please provide your Two Factor Authentication Code"
	},
	on2fa: {
		ENG: "Two Factor Authentication Code",
		FRA: "Two Factor Authentication Code"
	},
	pleaseSpecifyBranch: {
...
var gitAccountsNav = [
    {
        'id': 'git-account-management',
        'label': translation.gitAccountManagement[LANG],
        'checkPermission': {
            'service': 'repositories',
            'route': '/git/account',
            'method': 'get'
        },
        'url': '#/gitAccountManagement',
        'tplPath': 'modules/dashboard/gitManagement/directives/list.tmpl',
        'icon': 'git',
        'pillar': {
            'name': 'development',
        ...
        'tracker': true,
        'order': 1,
        'scripts': ['modules/dashboard/gitManagement/config.js', 'modules/dashboard/gitManagement/controller.js'],
