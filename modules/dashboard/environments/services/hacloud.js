...
hacloudServices.service('hacloudSrv', [ 'ngDataApi', 'hacloudSrvRedeploy', '$timeout', '$modal', '$sce', '$window', function (ngDataApi, hacloudSrvRedeploy, $timeout, $modal, $sce, $window) {
	/**
	 * Service Functions
	 * @param currentScope
	 * @param env
