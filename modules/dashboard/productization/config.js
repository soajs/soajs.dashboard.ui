var productizationConfig = {
	...
	'permissions':{
		'listProduct' :['multitenant', '/product', 'get'],
		'listConsoleProducts' :['multitenant', '/product/console', 'get'],
		'addProduct' : ['multitenant', '/product', 'post'],
		'deleteProduct' :['multitenant', '/product', 'delete'],
		'editProduct':['multitenant', '/product', 'put'],
		'listPck' : ['multitenant', '/product/packages', 'get'],
		'addPck' : ['multitenant', '/product/packages', 'post'],
		'deletePck' : ['multitenant', '/product/packages', 'delete'],
		'updatePck' : ['multitenant', '/product/packages', 'put'],
		'updateProdScope' : ['multitenant', '/product/scope', 'put'],
		'previewPackService': ['multitenant', '/product/packages/acl/service', 'get'],
		'previewPackApi': ['multitenant', '/product/packages/acl/api', 'get'],
	}
};