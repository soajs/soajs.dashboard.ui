"use strict";
let resourceConfig = soajsApp.components;
resourceConfig.controller('resourceConfigViewCtrl', ['$scope', '$timeout', '$modal', '$compile', 'ngDataApi', 'injectFiles', '$cookies', '$routeParams', '$localStorage',
	function ($scope, $timeout, $modal, $compile, ngDataApi, injectFiles, $cookies, $routeParams, $localStorage) {
		...
		$scope.saveACl = function () {
			let opts = {
				"method": "put",
				"routeName": '/console/registry/resource/acl',
				"data": {
		...
		injectFiles.injectCss("modules/dashboard/environments/resourceDetailView/resourceAcl.css");
		$scope.getResources();
