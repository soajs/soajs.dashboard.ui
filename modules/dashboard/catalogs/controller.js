...
catalogApp.controller('catalogAppCtrl', ['$scope', '$timeout', '$modal', 'ngDataApi', 'injectFiles', function ($scope, $timeout, $modal, ngDataApi, injectFiles) {
  ...
  //case of custom repo
    ...
    if (data.recipe.deployOptions.sourceCode && data.recipe.deployOptions.sourceCode.configuration ) {
          ...
          if (data.recipe.deployOptions.sourceCode.configuration.repo !== '') {
    ...
    function mapDataToForm(modalScope, postForm) {
      ...
      if (data.recipe.deployOptions.sourceCode && data.recipe.deployOptions.sourceCode.configuration && data.recipe.deployOptions.sourceCode.configuration.branch.length !== 0) {
  ...
  $scope.add = false;
    ...
    getAccounts(function (response, error) {
      if (recipe.recipe.deployOptions.sourceCode && recipe.recipe.deployOptions.sourceCode.configuration && recipe.recipe.deployOptions.sourceCode.configuration.repo !== '' && recipe.recipe.deployOptions.sourceCode.configuration.branch !== '') {
        let options = {
